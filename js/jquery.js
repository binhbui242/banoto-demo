...
window.onload = function() {
    ...
    input.addEventListener('change',function(){
        document.getElementById('tt').innerHTML=input.value*1115120000  + " đ";
        document.getElementById('ttt').innerHTML=document.getElementById('tt').innerHTML;
        document.getElementById('tttt').innerHTML=document.getElementById('tt').innerHTML;
    })
}
// tinh tien